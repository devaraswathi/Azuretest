package com.kroger.b2b.exampleservice.adapter.in.ospwebhook;

import static com.kroger.b2b.exampleservice.service.ThingService.SendThingEventCommand.INITIAL_ATTEMPT;

import com.kroger.b2b.exampleservice.adapter.in.ospwebhook.validators.ValidWebhookEvent;
import com.kroger.b2b.exampleservice.adapter.in.ospwebhook.validators.ValidWebhookSignature;
...
import com.kroger.b2b.exampleservice.service.ThingService;
import com.kroger.b2b.exampleservice.service.ThingService.SendThingEventCommand;
...
class OspWebhookController {
  ...
  void thingAction(
    ...
    SendThingEventCommand command = new SendThingEventCommand(
